...
public class DataRepository {
    ...
    public static ArrayList<OrdenServicio> getOrdenServicio() {return listaOrdenServicio;}
    ...
    public static void cargarDatos() {
        ...
        addCliente(new Cliente("0922222222", "Empresa S.A..", "Urdesa", "0955555555", TipoCliente.EMPRESARIAL));
