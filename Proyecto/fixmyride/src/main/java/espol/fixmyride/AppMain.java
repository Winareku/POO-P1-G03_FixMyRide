...
public class AppMain {
    public static void main(String[] args) {
        ...
        VistaOrdenServicio vistaOrdenServicio = new VistaOrdenServicio(controladorOrdenServicio, controladorServicio);
        ...
        do {
            ...
            // Opción llama a un método que devuelve la opción seleccionada por el usuario
            opcion = vistaMenuPrincipal.mostrarMenuPrincipal();

            // Manejo de opciones del menú principal (Hay que agregar más opciones)
            switch (opcion) {
                case 1:
    ...
    private static void inicializarApp( ControladorCliente controladorCliente,
